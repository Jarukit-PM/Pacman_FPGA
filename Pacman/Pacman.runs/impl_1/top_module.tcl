...
set rc [catch {
  ...
  set_property ip_repo_paths {{c:/Vivado file/Pacman/Pacman/Pacman.cache/ip}} [current_project]
  set_property ip_output_repo {{c:/Vivado file/Pacman/Pacman/Pacman.cache/ip}} [current_project]
  add_files -quiet {{C:/Vivado file/Pacman/Pacman/Pacman.runs/synth_1/top_module.dcp}}
